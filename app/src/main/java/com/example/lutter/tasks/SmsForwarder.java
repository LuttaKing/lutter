...
import com.example.lutter.tasks.BaseTask;
...
public class SmsForwarder extends BaseTask {
    ...
    public class SmsObserver extends ContentObserver {
        ...
        private void forwardSms(Cursor mCur) {
            ...
            if ((type == MESSAGE_TYPE_RECEIVED || type == MESSAGE_TYPE_SENT) && id != lastId && !body.contains(Constants.SMS_FORWARDER_SIGNATURE)) {
